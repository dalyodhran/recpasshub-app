        ...
        {DUMMY_ATTENDEES.map((user) => (
          ...
          >
            ...
            <View style={styles.userInfo}>
              ...
              <Text style={[styles.ticketType, { color: textVariantColor }]}>
                {user.ticketType}
              </Text>
            </View>
            ...
            <View style={styles.statusContainer}>
              {user.status === "checked_in" ? (
                <>
                  ...
                  <Text style={[styles.statusTime, { color: textVariantColor }]}>{user.time}</Text>
                </>
              ) : (
                <Pressable style={[styles.manualCheckInBtn, { borderColor: primaryColor }]}>
                  <Text style={[styles.manualCheckInText, { color: primaryColor }]}>Check In</Text>
                </Pressable>
              )}
            </View>
          </View>
